...
font_name = pygame.font.match_font('arial',48)
...
#testing displaying of a mathematical question
font = pygame.font.SysFont("arial",45)
question_text = "2+2 ="
question_surface = font.render(question_text,True,WHITE) # True is for anti aliasing
question_x = (WIDTH - question_surface.get_width()) // 2
question_y = (HEIGHT - question_surface.get_height()) // 2
